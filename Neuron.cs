...
namespace SLN
{
    ...
    public class Neuron
    {
        ...
        public double i_const_morris;
        public double v_prev;
        ...
        internal double getFrequency(int lastTimestamp, int window_size)
        {
            int firstTimestamp = lastTimestamp - window_size + 1;
            int firstIndex = _spikeList.FindIndex(
                delegate (int spk)
                {
                    return spk >= firstTimestamp;
