...
public static class BinarySerialization
{
    ...
    {
        Console.WriteLine("Saving the network to file...");
        ...
        Console.WriteLine($"Network saved. File size: {fileSize} byte.");
    }
    ...
    public static T ReadFromBinaryFile<T>(string filePath)
    {
        ...
        long fileSize = fileInfo.Length;
        T class_imported;
        Console.WriteLine($"Importing network. File size: {fileSize} byte.");
        using (Stream stream = File.Open(filePath, FileMode.Open))
        {
            var binaryFormatter = new System.Runtime.Serialization.Formatters.Binary.BinaryFormatter();
            class_imported = (T)binaryFormatter.Deserialize(stream);
        }
        Console.WriteLine("Network imported");
